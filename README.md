...
+ Para instalar Python (https://www.python.org/downloads/) y Visual Studio para Windows (https://code.visualstudio.com/), primero se descarga el instalador de Python desde el sitio web oficial. Una vez que descargado el instalador, se ejecuta y se siguen las instrucciones en pantalla. El instalador permitirá elegir la versión de Python que desea instalar, así como la ubicación en la que desea instalarla. Una vez que Python esté instalado, debe descargar e instalar la extensión de Python para Visual Studio desde el Marketplace. La extensión de Python permitirá escribir,   ejecutar y depurar código Python en Visual Studio. Para descargar la extensión, se abre Visual Studio y se dirige a la pestaña Comunidad. Luego, se hace clic en el botón Obtener extensiones y se busca la extensión Python. Una vez que haya encontrado la extensión, se hace clic en el botón Instalar. Una vez que la extensión de Python esté instalada, ya se podra comenzar a programar en Python en Visual Studio y usalro para cargar los datos a CouchDB. 
